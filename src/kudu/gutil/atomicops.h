...
#include "kudu/gutil/auxiliary/atomicops-internals-arm-v6plus.h" // @manual // IWYU pragma: export
#elif defined(ARMV3)
#include "kudu/gutil/auxiliary/atomicops-internals-arm-generic.h" // @manual // IWYU pragma: export
...
#include "kudu/gutil/auxiliary/atomicops-internals-windows.h" // @manual // IWYU pragma: export
