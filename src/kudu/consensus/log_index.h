...
//
// This structure is on-disk but *not durable*. We use mmap()ed IO to write it
// out, and never sync it to disk. Its only purpose is to allow random-reading
// earlier entries from the log to serve to Raft followers.
//
