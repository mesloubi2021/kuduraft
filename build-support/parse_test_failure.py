        ...
        for line in line_iter:
            ...
            if m:
                ...
                remaining_lines = [
                    ...
                    if STACKTRACE_ELEM_RE.search(line)
                    and not IGNORED_STACKTRACE_ELEM_RE.search(line)
                ]
...
def main():
    ...
    parser.add_argument(
        "path", nargs="?", help="File to parse. If not provided, parses stdin"
    )
